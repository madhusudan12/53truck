...
class MyForm(QtWidgets.QMainWindow):
  ...
  def insertvalues(self):
    with con:
      ...
      wheelbase = str(self.ui.lineEdit_4.text())
      length = str(self.ui.lineEdit_5.text())
      width = str(self.ui.lineEdit_6.text())
      height = str(self.ui.lineEdit.text())	
      cur.execute('INSERT INTO shape VALUES(?,?,?,?,?)',([cid,wheelbase,length,width,height]))
      con.commit()
